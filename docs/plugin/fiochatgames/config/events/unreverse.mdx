...
# Game Preview (UNREVERSE)

![FioChatGames UNREVERSE](../../../../img/fiochatgames/FioChatGames%20UNREVERSE.png)

---

File Location: `plugin\\fiochatgames\\config\\events\unreverse.yml`
...
# ==================================================================================================
game: UNREVERSE
folder: games/events/unreverse.yml
...
messages:
  ...
  start:
    ...
    - '<center><#808080><smallfont:unreverse></center>'
    - ''
  ...
  ended:
    ...
    - ' '
title:
  text: '<#ffb88f>Unreverse'
  enabled: true
subtitle:
  text: '<gray>%unreverse%</gray>'
  enabled: true
