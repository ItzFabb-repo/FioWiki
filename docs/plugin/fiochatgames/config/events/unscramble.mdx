...
# Game Preview (UNSCRAMBLE)

![FioChatGames UNSCRAMBLE](../../../../img/fiochatgames/FioChatGames%20UNSCRAMBLE.png)

---

File Location: `plugin\\fiochatgames\\config\\events\unscramble.yml`
...
# ==================================================================================================
game: UNSCRAMBLE
folder: games/events/unscramble.yml
...
messages:
  ...
  start:
    ...
    - ' '
    - '<center><#99cfff><bold>Chat Event</bold></center>'
    - '<center><#808080><smallfont:unscramble></center>'
    - ''
    ...
    - '<center><#99cfff><shadow:#000000:1.0>%word%</shadow></center>'
    - ' '
    - "<center><#7a7a7a><strikethrough>                                                             </strikethrough></center>"
    - ' '
  finish:
    ...
    - '<center><#99cfff><shadow:#00FF00:0.3>%answer%</shadow></center>'
    - ' '
    - "<center><#7a7a7a><strikethrough>                                                             </strikethrough></center>"
    - ' '
  ended:
    ...
    - '<center><gray>The answer was:</gray><dark_gray>:</dark_gray></center>'
    - '<center><#99cfff><shadow:#FF0000:0.3>%answer%</shadow></center>'
    - ' '
    - "<center><#7a7a7a><strikethrough>                                                             </strikethrough></center>"
    - ' '
title:
  text: '<#99cfff>Unscramble'
  enabled: true
subtitle:
  text: '<gray>%unscramble%</gray>'
  enabled: true
