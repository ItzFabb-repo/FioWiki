...
- [Spigot API: `org.bukkit.Sound`](https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Sound.html)
...
- Sounds: [Spigot API: `org.bukkit.Sound`](https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Sound.html)
...
- MiniMessage tags: [PaperMC Docs: MiniMessage format and standard tags](https://docs.papermc.io/adventure/minimessage/format/)
