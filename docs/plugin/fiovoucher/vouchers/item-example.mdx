...
```yaml
- "[ITEM] WOODEN_SWORD 1 <flags:HIDE_ATTRIBUTES,HIDE_ENCHANTMENTS,HIDE_DYED_COLOR,HIDE_DESTROYS> name:<green>Ordinary Sword"
```
...
actions:
  ...
  - "[ITEM] WOODEN_SWORD 1 <flags:HIDE_ATTRIBUTES,HIDE_ENCHANTMENTS,HIDE_DYED_COLOR,HIDE_DESTROYS> name:<green>Ordinary Sword lore:<gray>But with no attributes information."
