...
For a full explanation of each objective action such as `BLOCK_BREAK`, `TRADING`, `PLACEHOLDERAPI`, and `MANUAL`, see [Objective Actions](/plugin/fiocommunityquests/quests/actions-reference).
