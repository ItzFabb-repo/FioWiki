...
`confirmationTeam/anchor-remove.yml` is part of the BetterFioExtensions bundled menu configuration. Confirmation menu for removing team anchor.

Bundled title line:

```yaml
title: "<black><bold>| <dark_gray>ᴄᴏɴꜰɪʀᴍ ᴀɴᴄʜᴏʀ ʀᴇᴍᴏᴠᴇ"
```
...
```yaml
  confirm:
    ...
    type: "CONFIRM"
    material: LIME_DYE
    name: "<green>Confirm Anchor Removal"
    lore:
      - "<dark_gray>ᴄᴏɴꜰɪʀᴍ"
      - " "
      - "<gray>ᴄᴏɴꜰɪʀᴍ ʏᴏᴜʀ ᴀᴄᴛɪᴏɴ ʙᴇꜰᴏʀᴇ"
      - "<gray>ʀᴇᴍᴏᴠɪɴɢ ʏᴏᴜʀ ᴄᴜʀʀᴇɴᴛ"
      - "<gray>ᴛᴇᴀᴍ ᴀɴᴄʜᴏʀ ʟᴏᴄᴀᴛɪᴏɴ."
      - " "
...
- This confirmation menu is opened from the team anchor menu.
- The extension performs removal when the confirm item is clicked.

:::info[Source]
This page is based on `confirmationTeam/anchor-remove.yml` from the BetterFioExtensions project.
:::
