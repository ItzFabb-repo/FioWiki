...
`Team Menu/Leaderboard/members.yml` is part of the BetterFioExtensions bundled menu configuration. Members leaderboard page.

Bundled title line:

```yaml
title: "<black><bold>| <dark_gray>ᴍᴇᴍʙᴇʀꜱ ʟᴇᴀᴅᴇʀʙᴏᴀʀᴅ"
```
...
- Generated entries use the member-count metric.
- Use `SORT` and pagination for list control.

:::info[Source]
This page is based on `Team Menu/Leaderboard/members.yml` from the BetterFioExtensions project.
:::
