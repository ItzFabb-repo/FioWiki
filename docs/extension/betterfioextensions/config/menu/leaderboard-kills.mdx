...
`Team Menu/Leaderboard/kills.yml` is part of the BetterFioExtensions bundled menu configuration. Kills leaderboard page.

Bundled title line:

```yaml
title: "<black><bold>| <dark_gray>ᴋɪʟʟꜱ ʟᴇᴀᴅᴇʀʙᴏᴀʀᴅ"
```
...
- Generated entries use the kills metric.
- Use `SORT` and pagination for list control.

:::info[Source]
This page is based on `Team Menu/Leaderboard/kills.yml` from the BetterFioExtensions project.
:::
