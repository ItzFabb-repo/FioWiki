...
`Team Menu/Leaderboard/money.yml` is part of the BetterFioExtensions bundled menu configuration. Money leaderboard page.

Bundled title line:

```yaml
title: "<black><bold>| <dark_gray>ᴍᴏɴᴇʏ ʟᴇᴀᴅᴇʀʙᴏᴀʀᴅ"
```
...
- Generated entries use the money metric.
- Use `SORT` and pagination for list control.

:::info[Source]
This page is based on `Team Menu/Leaderboard/money.yml` from the BetterFioExtensions project.
:::
