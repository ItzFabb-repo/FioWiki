...
`Team Menu/Leaderboard/deaths.yml` is part of the BetterFioExtensions bundled menu configuration. Deaths leaderboard page.

Bundled title line:

```yaml
title: "<black><bold>| <dark_gray>ᴅᴇᴀᴛʜꜱ ʟᴇᴀᴅᴇʀʙᴏᴀʀᴅ"
```
...
- Generated entries use the deaths metric.
- Use `SORT` and pagination for list control.

:::info[Source]
This page is based on `Team Menu/Leaderboard/deaths.yml` from the BetterFioExtensions project.
:::
